              ...
              <div className="flex items-center justify-between px-4 py-3 bg-primary">
                ...
                >
                  {copied ? (
                    ...
                    <Copy className="w-4 h-4 text-primary-foreground/60" />
                  )}
                </button>
              </div>

              {/* Code */}
              <div className="bg-primary/95 p-5 overflow-x-auto">
                <pre className="text-sm text-primary-foreground/90 font-mono leading-relaxed">
